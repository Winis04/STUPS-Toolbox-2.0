   ...
   private void checkResult(Object elementToCheck) {
    ...
    public Start parse() throws ParserException, LexerException, IOException
    {
        ...
        while(true)
        {
		    ...
		    break;
                    case 4: /* reduce ASingleSymbolSymbolList */
		    {
			ArrayList list = new4();
			push(goTo(3), list);
		    }
		    break;
                    case 5: /* reduce AMultSymbolSymbolList */
		    {
			ArrayList list = new5();
			push(goTo(3), list);
		    }
		    break;
                    case 6: /* reduce ASingleRuleRuleList */
		    {
			ArrayList list = new6();
			push(goTo(4), list);
		    }
		    break;
                    case 7: /* reduce AMultRuleRuleList */
		    {
			ArrayList list = new7();
			push(goTo(4), list);
		    }
		    break;
                    case 8: /* reduce ARuleRule */
		    {
			ArrayList list = new8();
			push(goTo(5), list);
		    }
    ...
    ArrayList new0() /* reduce AGrammarS */
    {
        ...
        {
            // Block
        PSymbols psymbolsNode2;
        LinkedList listNode4 = new LinkedList();
        psymbolsNode2 = (PSymbols)nodeArrayList1.get(0);
        {
            // Block
	...
	if(listNode3 != null) //Macro:ParserTypedLinkedListAddAll
	{
      listNode4.addAll(listNode3);
        ...
        prootNode1 = new ARoot(psymbolsNode2, listNode4);
        }
    ...
    ArrayList new1() /* reduce ASymbolsSymbols */
    {
        this.firstPopped = null;
        this.lastPopped = null;
          ArrayList nodeList = new ArrayList();
	...
	if(listNode6 != null) //Macro:ParserTypedLinkedListAddAll
	{
      listNode7.addAll(listNode6);
        ...
        tsymbolNode9 = (TSymbol)nodeArrayList10.get(0);

        psymbolsNode1 = new ASymbols(listNode3, listNode5, listNode7, tidentifierNode8, tsymbolNode9);
        }
	nodeList.add(psymbolsNode1);
        // return nodeList;
        final ArrayList containerList = nodeList;
        Object elementToCheck = containerList.get(0);
        checkResult(elementToCheck);
    ...
    ArrayList new4() /* reduce ASingleSymbolSymbolList */
    {
        this.firstPopped = null;
        this.lastPopped = null;
          ArrayList nodeList = new ArrayList();
        ...
        {
            // Block
        TSymbol tsymbolNode1;
        tsymbolNode1 = (TSymbol)nodeArrayList1.get(0);
	if(tsymbolNode1 != null)
	{
	  listNode2.add(tsymbolNode1);
	}
        }
	nodeList.add(listNode2);
        // return nodeList;
    ...
    ArrayList new5() /* reduce AMultSymbolSymbolList */
    {
        this.firstPopped = null;
        this.lastPopped = null;
          ArrayList nodeList = new ArrayList();
    ...
    ArrayList new6() /* reduce ASingleRuleRuleList */
    {
        this.firstPopped = null;
        this.lastPopped = null;
          ArrayList nodeList = new ArrayList();
    ...
    ArrayList new7() /* reduce AMultRuleRuleList */
    {
        this.firstPopped = null;
        this.lastPopped = null;
          ArrayList nodeList = new ArrayList();
    ...
    ArrayList new8() /* reduce ARuleRule */
    {
        this.firstPopped = null;
        this.lastPopped = null;
          ArrayList nodeList = new ArrayList();
        ...
        TSymbol tsymbolNode3;
        TSymbol tsymbolNode4;
        LinkedList listNode6 = new LinkedList();
        tidentifierNode2 = (TIdentifier)nodeArrayList1.get(0);
        tsymbolNode3 = (TSymbol)nodeArrayList3.get(0);
        tsymbolNode4 = (TSymbol)nodeArrayList5.get(0);
        {
            // Block
        LinkedList listNode5 = new LinkedList();
	...
	if(listNode5 != null) //Macro:ParserTypedLinkedListAddAll
	{
      listNode6.addAll(listNode5);
        ...
        pruleNode1 = new ARule(tidentifierNode2, tsymbolNode3, tsymbolNode4, listNode6);
        }
...
/*      {
			...
			{{-1, ERROR, 3}, {8, SHIFT, 6}, },
			{{-1, REDUCE, 4}, {6, SHIFT, 9}, },
			{{-1, ERROR, 5}, {5, SHIFT, 10}, },
			{{-1, ERROR, 6}, {6, SHIFT, 11}, },
			{{-1, REDUCE, 0}, },
			{{-1, REDUCE, 6}, {8, SHIFT, 6}, },
			{{-1, ERROR, 9}, {9, SHIFT, 4}, },
			{{-1, ERROR, 10}, {9, SHIFT, 4}, },
			{{-1, ERROR, 11}, {9, SHIFT, 15}, },
			{{-1, REDUCE, 7}, },
			{{-1, REDUCE, 5}, },
			{{-1, ERROR, 14}, {5, SHIFT, 16}, },
			{{-1, ERROR, 15}, {6, SHIFT, 17}, },
			{{-1, ERROR, 16}, {8, SHIFT, 18}, },
			{{-1, ERROR, 17}, {9, SHIFT, 20}, },
			{{-1, REDUCE, 2}, {6, SHIFT, 21}, },
			{{-1, ERROR, 19}, {5, SHIFT, 22}, },
			{{-1, ERROR, 20}, {0, SHIFT, 23}, },
			{{-1, ERROR, 21}, {8, SHIFT, 18}, },
			{{-1, ERROR, 22}, {8, SHIFT, 25}, },
			{{-1, ERROR, 23}, {9, SHIFT, 4}, },
			{{-1, REDUCE, 3}, },
			{{-1, ERROR, 25}, {5, SHIFT, 27}, },
			{{-1, REDUCE, 8}, },
			{{-1, ERROR, 27}, {9, SHIFT, 28}, },
			{{-1, ERROR, 28}, {4, SHIFT, 29}, },
			{{-1, REDUCE, 1}, },
        };*/
...
/*      {
			0, 1, 2, 3, 4, 5, 6, 2, 7, 1, 1, 1, 2, 8, 5, 6, 3, 1, 9, 5, 10, 3, 3, 1, 5, 5, 7, 1, 11, 3, 
        };*/
