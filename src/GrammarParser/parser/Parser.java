...
package GrammarParser.parser;

import GrammarParser.lexer.*;
   ...
   private void checkResult(Object elementToCheck) {
	...
	if(listNode4 != null) //Macro:ParserTypedLinkedListAddAll
	{
      listNode5.addAll(listNode4);
        ...
        psymbolsNode1 = new ASymbols(listNode3, listNode5, tidentifierNode6);
        }
	...
	if(listNode3 != null) //Macro:ParserTypedLinkedListAddAll
	{
      listNode4.addAll(listNode3);
        ...
        pruleNode1 = new ARule(tidentifierNode2, listNode4);
        }
...
/*      {
			...
			{{-1, ERROR, 11}, {9, SHIFT, 4}, },
			{{-1, REDUCE, 7}, },
			{{-1, REDUCE, 5}, },
			{{-1, REDUCE, 2}, {6, SHIFT, 17}, },
			{{-1, ERROR, 15}, {5, SHIFT, 18}, },
			{{-1, REDUCE, 8}, },
			{{-1, ERROR, 17}, {8, SHIFT, 14}, },
			{{-1, ERROR, 18}, {8, SHIFT, 20}, },
			{{-1, REDUCE, 3}, },
			{{-1, ERROR, 20}, {4, SHIFT, 21}, },
			{{-1, REDUCE, 1}, },
        };*/
...
/*      {
			0, 1, 2, 3, 4, 5, 6, 2, 7, 1, 3, 1, 2, 8, 9, 5, 7, 3, 3, 5, 10, 3, 
        };*/
