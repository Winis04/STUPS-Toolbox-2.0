...
public class Lexer implements ITokenListContainer
{
    ...
    Token new1(  int line,   int pos) { return new TArrowStart(line, pos); }
    Token new2(  int line,   int pos) { return new TArrowEnd(line, pos); }
    Token new3(  int line,   int pos) { return new TLBracket(line, pos); }
    Token new4(  int line,   int pos) { return new TRBracket(line, pos); }
    Token new5(  int line,   int pos) { return new TLBracket2(line, pos); }
    Token new6(  int line,   int pos) { return new TRBracket2(line, pos); }
    ...
    Token new10(  String text,   int line,   int pos) { return new TListArg(text, line, pos); }
...
/*  {
        { // INITIAL
            {{9, 9, 1}, {10, 10, 2}, {13, 13, 3}, {32, 32, 4}, {39, 39, 5}, {40, 40, 6}, {41, 41, 7}, {44, 44, 8}, {45, 45, 9}, {59, 59, 10}, {65, 90, 11}, {95, 95, 12}, {97, 122, 13}, {123, 123, 14}, {125, 125, 15}, },
            {{9, 32, -2}, },
            {{9, 32, -2}, },
            {{9, 32, -2}, },
            {{9, 32, -2}, },
...
/*  {
        // INITIAL
        {-1, 0, 0, 0, 0, -1, 3, 4, 8, -1, 7, 9, 9, 9, 5, 6, -1, 1, 9, 9, 9, 9, 10, 2, },
